  ...
  ${styles.paddingY}`}
    ...
    xl:px-0 sm:px-16 px-6`}
      ...
      >
        ...
        <div className="absolute z-[0] w-[80%] h-[35%] top-0 rounded-full bottom-40 white__gradient" />
        <div className="absolute z-[0] w-[50%] h-[35%] right-20 bottom-20 top-0 blue__gradient" />
      </div>
      {/* at small size the button will show in bottom */}
